...
<?php $component->withAttributes(['class' => 'ml-4 mt-4']); ?>
        <a href="/teacher/input_data"><?php echo e(__('Input Data')); ?></a>
...
<?php endif; ?>
  ...
  <tbody>
    <?php 
    $no=1; ?>
      <?php $__currentLoopData = $teacher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      ...
      <td class="border">
        <a href="/teacher/update/<?php echo e($row->id); ?>">Update</a>
        |
        <a href="/teacher/delete/<?php echo e($row->id); ?>">Delete</a>
      </td>
    </tr>
...
<?php endif; ?>
<?php /**PATH E:\xamppNew\htdocs\portal\resources\views/admin/teacher/index.blade.php ENDPATH**/ ?>