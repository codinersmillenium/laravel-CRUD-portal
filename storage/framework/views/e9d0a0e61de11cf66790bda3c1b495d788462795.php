    ...
    <body class="antialiased">
        ...
        <div class="header" id="myHeader">
            <marquee direction="right" width="100%">
                <h2><b>Others teach you english, we make you speak english. So, Let's speak english with us!!!</b></h2>
            </marquee>
        </div>
...
<?php endif; ?>
        ...
        <form class="login-box" method="POST" action="<?php echo e(route('login')); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ml-0 text-sm text-gray-700 dark:text-gray-500 underline">Don't have any account? Register</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
...
<?php /**PATH C:\Users\ASUS\Documents\Laravel-Jetstream-MultiAuth-Roles\resources\views/welcome.blade.php ENDPATH**/ ?>